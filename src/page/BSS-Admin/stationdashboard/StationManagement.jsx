                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1">
                          <div className="text-sm font-medium text-blue-600">Địa chỉ</div>
                          <div className="text-sm text-gray-700 mt-1">{selectedStation.address}</div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
                        ...
                        <div className="flex-1">
                          <div className="text-sm font-medium text-blue-600">Quản lý</div>
                          <div className="text-sm text-gray-700">{selectedStation.manager}</div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-6 h-6 bg-blue-100 rounded-md flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex-1">
                          <div className="text-sm font-medium text-blue-600">Số điện thoại</div>
                          <div className="text-sm text-gray-700">{selectedStation.phone}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-3 border border-green-100">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-2">
                      <div className="text-center bg-white rounded-lg p-2 shadow-sm">
                        <div className="text-lg font-bold text-green-600">{selectedStation.batteryFull}</div>
                        <div className="text-sm text-gray-600">Pin đầy</div>
                      </div>
                      <div className="text-center bg-white rounded-lg p-2 shadow-sm">
                        <div className="text-lg font-bold text-yellow-600">{selectedStation.batteryCharging}</div>
                        <div className="text-sm text-gray-600">Đang sạc</div>
                      </div>
                      <div className="text-center bg-white rounded-lg p-2 shadow-sm">
                        <div className="text-lg font-bold text-red-600">{selectedStation.batteryMaintenance}</div>
                        <div className="text-sm text-gray-600">Bảo dưỡng</div>
                      </div>
                      <div className="text-center bg-white rounded-lg p-2 shadow-sm">
                        <div className="text-lg font-bold text-indigo-600">{selectedStation.batteryCapacity}</div>
                    ...
                    <div className="bg-white rounded-lg p-2 shadow-sm">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-sm font-bold text-gray-900">{selectedStation.batteryHealth}%</span>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="bg-white rounded-lg p-3 text-center shadow-sm">
                        <div className="text-xl font-bold text-purple-600 mb-1">
                          {selectedStation.totalTransactions.toLocaleString("vi-VN")}
                        </div>
                        <div className="text-xs text-gray-600">Tổng giao dịch</div>
                      </div>
                      <div className="bg-white rounded-lg p-3 text-center shadow-sm">
                        <div className="text-xl font-bold text-green-600 mb-1">
                          {(selectedStation.monthlyRevenue / 1000000).toFixed(1)}M VNĐ
                        </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-3 border border-orange-100">
                    ...
                    <div className="space-y-2">
                      <div className="bg-white rounded-lg p-3 text-center shadow-sm">
                        ...
                        <div className="text-sm font-bold text-gray-900">{selectedStation.lastMaintenance}</div>
                </div>
                      <div className="bg-white rounded-lg p-3 text-center shadow-sm">
                        <div className="text-xs font-semibold text-gray-600 mb-1">Lần tiếp theo</div>
                        <div className="text-sm font-bold text-gray-900">{selectedStation.nextMaintenance}</div>
                    </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200 shadow-sm">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-gray-900">{stationToDelete.name}</h4>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                    <div className="bg-blue-50 rounded-lg p-2">
                      <p className="text-xs font-medium text-blue-600 mb-1">Quản lý</p>
                      <p className="text-xs font-semibold text-gray-900">{stationToDelete.manager}</p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-2">
                      <p className="text-xs font-medium text-green-600 mb-1">Sức khỏe pin</p>
                      <p className="text-xs font-bold text-yellow-600">{stationToDelete.batteryHealth}%</p>
                    </div>
                    <div className="bg-purple-50 rounded-lg p-2">
                      <p className="text-xs font-medium text-purple-600 mb-1">Giao dịch</p>
                      <p className="text-xs font-bold text-purple-600">{stationToDelete.totalTransactions.toLocaleString("vi-VN")}</p>
                    </div>
                    <div className="bg-orange-50 rounded-lg p-2">
                      <p className="text-xs font-medium text-orange-600 mb-1">Doanh thu</p>
                      <p className="text-xs font-bold text-orange-600">{(stationToDelete.monthlyRevenue / 1000000).toFixed(1)}M</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
              ...
              <div className="p-6 border-b border-gray-100">
                ...
                <h3 className="text-xl font-bold text-gray-900 text-center mb-2">
                  {stationToChangeStatus.status === "active" ? "Chuyển sang bảo dưỡng" : "Kích hoạt trạm"}
                </h3>
                <p className="text-gray-600 text-center">
                  Bạn có chắc chắn muốn {stationToChangeStatus.status === "active" ? "chuyển trạm sang chế độ bảo dưỡng" : "kích hoạt trạm"} không?
                </p>
              </div>
              ...
              <div className="p-6">
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-gray-900">{stationToChangeStatus.name}</h4>
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          {stationToChangeStatus.status === "active" ? "🟢 Hoạt động" : "🔴 Bảo dưỡng"}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 rounded-b-2xl">
                <div className="flex space-x-3">
                  ...
                  >
                    {stationToChangeStatus.status === "active" ? "Bảo dưỡng" : "Kích hoạt"}
                  </button>
                </div>
              </div>
            </div>
